(() => {
  ...
  const COMMANDS = {
    ...
    experience: () => [
      ...
      ["", ""],
      ["[2018] Website Developer, Tyrula LLC", "white"],
      ["  Non-profit site for rural youth education.", "dim"],
      ["", ""],
      ["[2016–2018] Website Developer, Jewels by Ashkosh", "white"],
      ["  Built and ran the online store.", "dim"],
      ["", ""],
    ],
    achievements: () => [
      ["talks & stages", "amber"],
